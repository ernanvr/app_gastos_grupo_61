...
class AppBarChart extends StatelessWidget {
  ...
  List<BarChartGroupData> get groups =>
      dataMap.entries.map((entry) {
        ...
        return BarChartGroupData(
          ...
          barsSpace: barSpace,
          barRods:
              groupData.asMap().entries.map((rod) {
  ...
  List<BarChartGroupData> get stacks =>
      dataMap.entries.map((entry) {
        final groupInt = entry.key;
        ...
        return BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
              ...
              borderRadius: barBorderRadius,
              rodStackItems:
                  stackData.asMap().entries.map((stack) {
...
class AppPieChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) => PieChart(
    PieChartData(
      ...
      sectionsSpace: 0,
      sections:
          data.data.asMap().entries.map((section) {
            String? title;
...
class AppChartLegendWidget extends StatelessWidget {
  const AppChartLegendWidget({
    super.key,
...
FlTitlesData getTitlesData(
  ...
  bottomTitles: AxisTitles(
    axisNameWidget:
        xAxisLabelInfo.title.isEmpty
            ? null
            : Text(xAxisLabelInfo.title, style: xAxisLabelInfo.titleTextStyle),
    axisNameSize:
        xAxisLabelInfo.titleTextStyle?.fontSize != null
            ? xAxisLabelInfo.titleTextStyle!.fontSize! + 12
            : 16,
    sideTitles: SideTitles(
      getTitlesWidget:
          (val, e) =>
              getXTitlesWidget != null
                  ? getXTitlesWidget(val, e)
                  : Text(
  ...
  leftTitles: AxisTitles(
    axisNameWidget:
        yAxisLabelInfo.title.isEmpty
            ? null
            : Text(yAxisLabelInfo.title, style: yAxisLabelInfo.titleTextStyle),
    axisNameSize:
        yAxisLabelInfo.titleTextStyle?.fontSize != null
