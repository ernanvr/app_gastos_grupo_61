...
import 'package:app_gastos_grupo_61/src/domain/entities/transaction_with_category.dart'; // Import the transaction entity

class TapTransactionOptionsWidget extends StatefulWidget {
  final TransactionWithCategory transaction; // Add transaction parameter
  final VoidCallback onTapDelete; // Add a callback for the delete action

  const TapTransactionOptionsWidget({
    super.key,
    required this.transaction, // Make transaction required
    required this.onTapDelete, // Make onTapDelete required
  });

  @override
  State<TapTransactionOptionsWidget> createState() =>
      _TapTransactionOptionsWidgetState();
}

class _TapTransactionOptionsWidgetState
    extends State<TapTransactionOptionsWidget> {
  @override
            ...
            FFButtonWidget(
              onPressed: () {
                ...
                GoRouter.of(context).pushNamed(
                  'update-transaction',
                  extra: widget.transaction, // Use widget.transaction
                );
              },
