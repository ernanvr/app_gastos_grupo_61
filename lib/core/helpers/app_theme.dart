...
class LightModeTheme extends AppTheme {
  ...
  late Color primary = const Color(0xFF3F37C9);
  late Color secondary = const Color(0xFF4361EE);
  late Color tertiary = const Color(0xFF00509D);
  late Color alternate = const Color(0xFF560BAD);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFFF6FFF8);
  late Color secondaryBackground = const Color(0xFFCCDBFD);
  late Color accent1 = const Color(0xFF4CC9F0);
  late Color accent2 = const Color(0xFF7209B7);
  late Color accent3 = const Color(0xFF4895EF);
  late Color accent4 = const Color(0xFFABC4FF);
